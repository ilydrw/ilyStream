import type { AppSettings, TTSUserVoiceOverride, VoiceModifiers } from './types'
...
function shouldCoerceNumber(key: string): boolean {
  return /(Port|MaxMessages|MaxLength|MinLength|DuplicateWindow|PerUserLimit|MaxTokens|FontSize|FontWeight|DurationMs|ImageTop|ImageLeft|Top|Left|Volume|Bitrate|Fps|Width|Height|Target|MaxQueueLength|MaxPerUser|VotesRequired|TokenExpiresAt|FlashDurationMs)$/.test(key)
}
