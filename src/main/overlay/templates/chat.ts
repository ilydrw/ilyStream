  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .role-badge-chip--team { color: #38bdf8; background: rgba(56,189,248,0.16); }
      .body {
      ...
      function makeEntry(item) {
        ...
        if (Array.isArray(item.badges) && item.badges.length) {
          var BADGE_SVG = {
            ...
            team: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.2 0 4-1.8 4-4s-1.8-4-4-4-4 1.8-4 4 1.8 4 4 4zm-7 8c0-2.8 4.7-4.5 7-4.5s7 1.7 7 4.5V21H5z"/></svg>'
          };
