  ...
  return (
    <div className="app-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
        <Metric 
          icon={<Users size={20} className="text-kick" />} 
          label="Kick Audience" 
          ...
          <section className="app-section-card glass">
            <div className="app-section-head">
              <div>
                ...
                <p>Channel name and stream credentials.</p>
              </div>
          ...
          <section className="app-section-card glass overflow-hidden">
            <div className="app-section-head">
              <div>
                ...
                <p>Status of the Kick WebSocket connection.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-12">
              <DiagnosticLine
                icon={<Radio size={16} />}
                label="WebSocket"
                value={isConnected ? 'Open / Receiving' : status.toUpperCase()}
        ...
        <section className="app-section-card glass flex flex-col">
          <div className="flex items-center justify-between px-8 py-5 border-b border-white/5 bg-white/[0.02]">
            <div className="flex items-center gap-3">
              <MessageSquareMore size={18} className="text-kick" />
