    ...
    <div className="app-page razer-page">
      <header className="app-page-header">
        <div className="flex items-center gap-5">
          <div className="app-page-title-icon razer-title-icon">
            <RazerIcon size={28} />
          </div>
          <div>
            <h1>Razer Chroma</h1>
            <p className="app-page-intro">
              Connect Synapse Chroma SDK and route stream effects to your BlackWidow keyboard and Basilisk mouse.
            </p>
          </div>
        </div>

        <div className="razer-actions">
          <button
            type="button"
