      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8">
          <section className="app-section-card glass h-full flex flex-col min-h-[400px]">
            ...
            <div className="flex-1 p-8 bg-white/[0.01] flex flex-col items-center justify-center text-center text-white/10 border border-dashed border-white/5 m-8 rounded-lg">
              <IconLayoutGrid size={64} className="mb-4 opacity-10" />
        ...
        <div className="lg:col-span-4 space-y-6">
          <section className="app-section-card glass p-8">
            <h3 className="text-sm font-semibold mb-4">Pairing Mode</h3>
            ...
            <button className="app-button-primary w-full !h-12 text-xs font-semibold tracking-tight">
              Start Pairing
            </button>
          </section>
        </div>
