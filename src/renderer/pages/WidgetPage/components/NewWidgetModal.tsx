          ...
          {templates.map((template) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-4 p-5 rounded-md bg-white/[0.03] border border-white/5 text-left hover:border-accent/30 hover:bg-white/[0.06] transition-all group cursor-pointer"
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-semibold text-white group-hover:text-accent transition-colors">{template.label}</h4>
