        ...
        {WIDGET_THEMES.map((theme) => {
          ...
          return (
            <button
              ...
              className={`group rounded-xl border p-3 text-left transition-all ${ selected ? 'border-lime-300/70 bg-lime-300/10 text-white shadow-[0_0_24px_rgba(182,255,0,0.12)]' : 'border-white/10 bg-white/[0.03] text-white/70 hover:border-lime-300/40 hover:bg-lime-300/5' }`}
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="truncate text-xs font-semibold tracking-tight">{theme.name}</div>
