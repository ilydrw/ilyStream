...
import { UserVoiceOverridesPanel } from './components/UserVoiceOverridesPanel'
      ...
      <div className="tts-tab-region flex-1 min-h-0 overflow-y-auto px-8 py-8">
        ...
        {activeTab === 'rules' && (
          <div className="tts-settings-layout tts-settings-layout--rules">
            ...
            <div className="flex flex-col gap-10">
              <UserVoiceOverridesPanel
                overrides={settings.tts.userVoiceOverrides}
                profiles={profiles}
                ...
                syncedElevenLabsVoices={syncedElevenLabsVoices}
                onChange={(overrides) => {
                  void updateSetting('ttsUserVoiceOverrides', overrides)
                }}
              />
            </div>
          </div>
