...
export function ChannelStrip({
  ...
  return (
    <div
      ...
      className={`pro-channel-strip ${selected ? 'is-selected' : ''} ${isMaster ? 'is-master' : ''} ${collapsed ? 'is-collapsed' : ''} ${dragActive ? 'is-dragging' : ''}`}
      style={stripStyle}
    >
      ...
      <div className="pro-channel-name-row" title={displayName}>
        ...
        <button
          type="button"
          className="pro-channel-collapse"
      ...
      {collapsed ? (
        <div className="pro-channel-collapsed-body">
