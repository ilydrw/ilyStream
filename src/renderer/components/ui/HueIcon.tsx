...
export function HueIcon({ size = 16, className = '' }: HueIconProps) {
  const gradientId = `hue-gradient-${React.useId().replace(/:/g, '')}`
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={gradientId} x1="0" x2="512" y1="258" y2="258" gradientTransform="matrix(1 0 0 -1 0 514)" gradientUnits="userSpaceOnUse">
